  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        <Button name={'Give Review'}  onPress={() => setModalVisible(true)}/>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
           <ModalGoBack name={'Leave a Review'} onPress={()=>{setModalVisible(false)}}/>
           <Image source={require('../../../assets/images/img6.png')} style={{height:responsiveHeight(10),width:responsiveWidth(20),}} />
           <Text style={styles.modalLargeText}>How would you rate John Doe?</Text>
           <View style={styles.rating}>
            <Image source={require('../../../assets/images/ratingFill.png')}/>
            <Image source={require('../../../assets/images/ratingFill.png')}/>
            <Image source={require('../../../assets/images/ratingFill.png')}/>
            <Image source={require('../../../assets/images/ratingFill.png')}/>
            <Image source={require('../../../assets/images/ratingUnfill.png')}/>
           </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalRegularText}>View submitted successfullyy</Text>
